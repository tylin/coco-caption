...
- PTBTokenizer: We use the [Stanford Tokenizer](http://nlp.stanford.edu/software/tokenizer.shtml) which is included in the [Stanford CoreNLP 3.4.1](http://nlp.stanford.edu/software/corenlp.shtml).
